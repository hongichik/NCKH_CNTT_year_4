                                            ...
                                            @foreach ($dataType->browseRows as $row)
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($row->type == 'text')
                                                        ...
                                                        @if ($row->field == 'file')
                                                            <a href="/{{mb_substr($data->{$row->field}, 0, 200) }}"
                                                ...
                                                @foreach ($actions as $action)
                                                    ...
                                                    @can($action->getPolicy(), $data)
                                                        @if ($action->shouldActionDisplayOnRow($data))
                                                            @if ($action->getIcon() == 'voyager-trash')
                                                                <a href="javascript:;" title="Xóa"
                                                            ...
                                                            @else
                                                                <a href="/admin/student-newspapers?id={{ $data->id }}" title="Chuyển trạng thái"
                                                                    class="btn btn-sm btn-info pull-right edit">
                                                                    <span class="hidden-xs hidden-sm">Chuyển trạng thái</span>
                                                                </a>
                                                            @endif
                                                        @endif
                                                    @endcan
